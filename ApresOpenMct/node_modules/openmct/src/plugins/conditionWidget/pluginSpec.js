...
function getView(openmct, domainObj, objectPath) {
    ...
    const conditionWidgetView = applicableViews.find((viewProvider) => viewProvider.key === 'conditionWidget');

    return conditionWidgetView.view(domainObj);
}
...
xdescribe("the plugin", function () {
    ...
    beforeEach((done) => {
        mockObjectPath = [
            {
                name: 'mock condition-widget',
                type: 'conditionWidget',
                identifier: {
                    key: 'mock-condition-widget',
                    namespace: ''
                }
            }
        ];
